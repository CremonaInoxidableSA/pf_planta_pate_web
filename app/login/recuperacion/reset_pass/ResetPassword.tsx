...
const ResetPassword = ({ initialToken }: ResetPasswordProps) => {
  ...
  if (validatingToken) {
    return (
      <section className="flex h-full w-full items-center justify-center">
        <div className="w-auto h-[40vh] gap-3.75 flex flex-col items-center justify-center p-[3rem_4rem_2rem_4rem] max-w-480 bg-background1 rounded">
  ...
  return (
    <section className="flex h-full w-full items-center justify-center">
      <div className="w-auto h-auto gap-3.75 flex flex-col items-center p-[3rem_4rem_2rem_4rem] max-w-480 bg-background1 rounded">
        <LogoBase64 className="flex w-[65%] p-0 h-auto" />
        ...
        >
          ...
          <Button
            disabled={loading}
            type="submit"
            className="bg-[#e82a31] mt-1.25 p-3 rounded w-full h-13 flex items-center justify-center border-none font-semibold cursor-pointer disabled:bg-[#a82328] disabled:cursor-not-allowed "
          >
